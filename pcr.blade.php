...
<center>
                <div class="col-lg-6">
                    <div class="contact-form">
                        <form  action="{{url('/uploadpcr')}}" method="POST"  enctype="multipart/form-data">

                          @csrf

                          <div class="row">
                            <div class="col-lg-12">
                               <b> <h3 style = "font-size:25px; color: #FFFAF0;">PCR Request</h3></b><br>
                            </div>
                            ...
                            <br>
                             <div class="col-md-6 col-sm-12">
                              <fieldset>
                               <input type="text" name="nic" placeholder="Your NIC Number" required="">
                              </fieldset><br>
                            </div>
